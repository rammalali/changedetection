...
def get_loader(data_name, img_size=256, batch_size=8, split='test',
               is_train=False, dataset='CDDataset', root_dir=None):
    if root_dir is None:
        ...
        label_transform = None  # For custom root_dir, assume no labels
    ...
    if dataset == 'CDDataset':
        ...
        raise NotImplementedError(
            'Wrong dataset name %s (choose one from [CDDataset, ImageDataset])'
            % dataset)
